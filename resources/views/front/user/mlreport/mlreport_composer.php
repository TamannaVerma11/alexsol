...
if(isset($_GET['report_format_id'])):
    ...
    // }
    if(isset($_GET['report_format_id']) && $_GET['report_format_id'] != "" && ($_SESSION['account-type'] == 'super_admin' || $_SESSION['account-type'] == 'support_admin')):
        echo "<input type='text' id='report_format_id' value='".$_GET['report_format_id']."' readonly hidden>";
        echo "<input type='text' id='report_lang_code' value='".$_SESSION['trans']."' readonly hidden>";

        $report = false;
        $report_content = false;
        $reportData = false;
        //$report = $Database->get_data('report_format_id', $_GET['id'], 'mlreport_format_content', true);
        
        $sql = "SELECT * FROM mlreport_format_contentd WHERE report_format_id={$_GET['report_format_id']} AND report_lang_code='{$_SESSION['trans']}'";
        ...
        $sqlData = "SELECT * FROM mlreport_format_content WHERE report_format_id={$_GET['report_format_id']} AND report_lang_code='{$_SESSION['trans']}'";
...
<div class="row user-content-row">
    <div class="col-12 report-dcomposer">
        <div class="report-composer-widget-title"><?php echo $trans->phrase("user_composer_phrase2"); ?> - <span><?php echo $reportData['report_title']; ?></span> <?php echo $trans->phrase("report_text"); ?></div>
        <div class="row user-content-row">
            <div class="col-12">
                <div class="accordion" id="composer_accordion">
                    ...
                    <div class="card">
                        <div class="card-header" id="composer_freetext15_heading">
                            <div style="padding: 30px 0px 30px 15px;">
                                <input class="form-check-input section-checker" type="checkbox" value="free_text15" id="free_text15_check" <?php echo ($report_content && $report_content['free_text15']['enabled']) ? 'checked' : ''; ?>>
                                <h3 class="accordion-heading mb-0" data-toggle="collapse" data-target="#free_text_15" aria-expanded="true" aria-controls="free_text_15">
                                    <?php echo $trans->phrase("pdf_text13"); ?>
                                </h3>
                            </div>
                        </div>
                        ...
                        <div id="free_text_15" class="collapse" aria-labelledby="composer_freetext15_heading" data-parent="#composer_accordion">
                            <div class="card-body">
                                <div class="form-group">
                                    <textarea id="composer_text_16" class="form-control composer-text"><?php echo ($report_content && $report_content['free_text15']['text']) ? $report_content['free_text15']['text'] : ""; ?></textarea>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="page_break17" id="composer_page_break17" <?php echo ($report_content && $report_content['free_text15']['page_break17']) ? 'checked' : ''; ?>>
                ...
                <br>
                <button type="button" id="save_mlreport_format" class="btn btn-success"><?php echo $trans->phrase('user_composer_phrase24'); ?></button>
            </div>
        </div>
    </div>
</div>
