                                    ...
                                    <form method="post" action="" id="myadminprofile" enctype="multipart/form-data">
                                        <div class="row clearfix">
                                            <div class="col-lg-12">
                                                <div class="">
                                                    <div class="profile-pic">
                                                        ...
                                                        <input id="file" class="admin_logo_input" type="file" data-admin="<?php echo $admin['admin_id']; ?>" accept=".jpg,.jpeg,.png" />
                                            ...
                                            <div class="col-md-6 col-sm-12 form-group">
                                                ...
                                                <input type="text" id="admin_name_editor_input" value="<?php echo $admin['admin_name']; ?>">
                                            </div>
                                            <div class="clearfix"></div>
                                            <input type="hidden" id="admin_email_editor_old" value="<?php echo $admin['admin_email']; ?>">

                                            <input type="hidden" id="admin_id_input" value="<?php echo $admin['admin_id']; ?>">
                                            <div class="col-md-6 col-sm-12 form-group">
                                                <span><?php echo $trans->phrase("user_admin_profile_phrase4"); ?></span>
                                                <input type="email" id="admin_email_editor_input" value="<?php echo $admin['admin_email']; ?>">
                                            </div>
                                            <div class="clearfix"></div>
                                            <div class="col-md-6 col-sm-12 form-group">
                                                <span><?php echo $trans->phrase("user_admin_profile_phrase5"); ?></span>
                                                <input type="text" id="admin_role_input" value="<?php echo $admin['admin_role']; ?>" disabled>
                                            </div>
                                            <div class="clearfix"></div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                                <button class="theme-btn btn-style-two view-button" type="submit" name="save"><span class="txt">Save</span></button>
                                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="row admin-row row-50">
                            <div class="col-12 admin-password change-password-container">
                                ...
                                <div id="admin_pass_editor" data-admin="<?php echo $admin['admin_id']; ?>" class="editor">
                                    <form class='form-inline'>

                                        <input type='password' id='admin_pass_editor_old' class="col-sm-12 form-fields" placeholder='<?php echo $trans->phrase("user_js_phrase1"); ?>'>
                                        <input type='password' id='admin_pass_editor_new' class="col-sm-12 form-fields" placeholder='<?php echo $trans->phrase("user_js_phrase2"); ?>'>
                                        <input type='password' id='admin_pass_editor_confirm' class="col-sm-12 form-fields" placeholder='<?php echo $trans->phrase("user_js_phrase3"); ?>'>
                            ...
                            <div class="col-12 admin-tfa change-tfa-container">
                                ...
                                <form class='' method="post" action="">
                                    <div class="d-flex mt-4 mb-3">
                                        ...
                                        <div class="">
                                            <input type="radio" name="tfa_status" value="1" id="tfa_enabled" <?= $admin['tfa_status'] ? 'checked' : '' ?> oninput="checkTfaStatus()" />
                                            <label for="tfa_enabled"><?php echo $trans->phrase("yes_email"); ?></label>
                                            <input type="radio" name="tfa_status" value="0" id="tfa_disabled" <?= !$admin['tfa_status'] ? 'checked' : '' ?> oninput="checkTfaStatus()" />
                                    ...
                                    <div class="inputs-holder d-none" id="inputs_holder">
                                        <div class="d-flex mt-4 mb-3">
                                            ...
                                            <div>
                                                <input type="radio" name="tfa_type" id="tfa_email" value="email" <?= $admin['tfa_type'] == 'email' ? 'checked' : '' ?> oninput="checkTfaType()" />
                                                <label for="tfa_email"><?php echo $trans->phrase("email_text"); ?></label>
                                                <input type="radio" name="tfa_type" id="tfa_phone" value="phone" <?= $admin['tfa_type'] == 'phone' ? 'checked' : '' ?> oninput="checkTfaType()" />
