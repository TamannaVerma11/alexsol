...
$(document).ready(function () {
    ...
    //Company user registration request and validation
    $(document).on("submit", "#regCompAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest("#regCompAjax", e, formData);

        return false;
    });

    //Invite user
    $(document).on("submit", "#regInviteAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest("#regInviteAjax", e, formData);

        return false;
    });

    //Tos registration request and validation
    $(document).on("submit", "#addTosAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest("#addTosAjax", e, formData);

        return false;
    });

    //Support send message
    $(document).on("submit", "#addSupAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest("#addSupAjax", e, formData);
    ...
    $('#support_email_editor_button').click(function () {
        let html = `
        <form action="`+ optionURL +`" method = 'post' class='form-inline' id='support_email_editor_save'>
            <input type='hidden' name='_token' value='`+ csrfToken +`'>
            <input type='text' name="support_email" id='support_email_editor_input' class='form-control form-control-sm'>
            <span class="text-danger validation_errors support_email_err"></span>
            <button name="submit" id='' class='btn btn-success btn-sm ml-2'><i class='fas fa-save'></i></button>
        </form>
        `;
        $(this).parents('#support_email_editor').html(html);
    });
    $(document).on("submit", "#support_email_editor_save", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest("#support_email_editor_save", e, formData);
    ...
    $('#support_phone_editor_button').click(function () {
        ...
        <form action="`+ optionURL +`" method = 'post' class='form-inline' id='support_email_editor_save'>
            <input type='hidden' name='_token' value='`+ csrfToken +`'>
            <input type='text' name="support_phone" id='support_phone_editor_input' class='form-control form-control-sm'>
            <span class="text-danger validation_errors support_email_err"></span>
            <button name="submit" id='' class='btn btn-success btn-sm ml-2'><i class='fas fa-save'></i></button>
        </form>
        `;
    ...
    $('#support_address_editor_button').click(function () {
        ...
        <form action="`+ optionURL +`" method = 'post' class='form-inline' id='support_email_editor_save'>
            <input type='hidden' name='_token' value='`+ csrfToken +`'>
            <textarea id='support_address_editor_input' name='support_address' class='form-control form-control-sm'></textarea>
            <input type='text' name="support_phone" id='support_phone_editor_input' class='form-control form-control-sm'>
            <span class="text-danger validation_errors support_email_err"></span>
            <button name="submit" id='' class='btn btn-success btn-sm ml-2'><i class='fas fa-save'></i></button>
        </form>
    ...
    // Support reply
    $(document).on("submit", "#addSupReplyAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest("#addSupReplyAjax", e, formData);
    ...
    $(document).on("submit", "#updateProfilAjax", function (e) {
        e.preventDefault();
                    ...
                    $.each(data.errors, function (key, val) {
                        if(key.indexOf('.') > -1){
                            ...
                            $('form .form.language').each(function () {
                                if ($(this).find(id + ' .validation_errors.' + key + '_err').length !== 0) {
                                    $(this).hide();
                                } else {
                                    $(this).show();
                                }
                        ...
                        $('#updateProfilAjax .validation_errors.' + key + '_err').text(val);
                    });
                }
            },
            error: function (data) {
                ...
                if($.inArray('errors'), data.responseJSON)
    ...
    //Password Change
    $(document).on("submit", "#updatePasswordAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest("#updatePasswordAjax", e, formData);
    ...
    //Add
    $(document).on("submit", "#addReportFormatAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#addReportFormatAjax', e, formData);
    ...
    // Update
    // Submit form data via Ajax
    $(document).on("submit", "#updateReportFormatAjax", function (e) {
        e.preventDefault();
        var formData = new FormData(this);
            ...
            success: function (data) {
                if (data.status) {
                    ...
                    $.each(data.errors, function (key, val) {
                        ...
                        $('#updateReportFormatAjax .validation_errors.' + key + '_err').text(val);
                    });
                }
            },
            error: function (data) {
    ...
    $(document).on("submit", "#request_na_ticketAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#request_na_ticketAjax', e, formData);

        return false;
	});

    $(document).on("submit", "#createTicketAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#createTicketAjax', e, formData);
    ...
    // package add
    $(document).on("submit", "#addPackageAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#addPackageAjax', e, formData);

        return false;
	});

    //Add new language
    $(document).on("submit", "#addLanguageAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#addLanguageAjax', e, formData);

        return false;
	});

    //Edit language name
    $(document).on("submit", "#editLanguageAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#editLanguageAjax', e, formData);

        return false;
	});

    //Active language name
    $(document).on("submit", "#activateLanguageAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#activateLanguageAjax', e, formData);

        return false;
	});

    //Deactive language name
    $(document).on("submit", "#deactivateLanguageAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#deactivateLanguageAjax', e, formData);

        return false;
	});

    //Default language name
    $(document).on("submit", "#defaultLanguageAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#defaultLanguageAjax', e, formData);

        return false;
	});

    //Add industry
    $(document).on("submit", "#addIndustryAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#addIndustryAjax', e, formData);

        return false;
	});
    //Update industry
    $(document).on("submit", "#updateIndustryAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#updateIndustryAjax', e, formData);

        return false;
	});

    //Add method
    $(document).on("submit", "#addMethodAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#addMethodAjax', e, formData);

        return false;
	});
    //Method companies
    $(document).on("submit", "#companiesMethodAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#companiesMethodAjax', e, formData);

        return false;
	});
    //Update method
    $(document).on("submit", "#updateMethodAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#updateMethodAjax', e, formData);
    ...
    $('#method_view').change(function () {
        ...
        if($(this).val() == 0)
            ...
            window.location = $(this).parent().attr('action')+'?company='+company_id;
    });

    // Add question
    $(document).on("submit", "#addQuestionAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#addQuestionAjax', e, formData);

        return false;
	});
    // Update question
    $(document).on("submit", "#updQuestionAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#updQuestionAjax', e, formData);
    ...
    // Add category
    $(document).on("submit", "#addCategoryAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#addCategoryAjax', e, formData);

        return false;
	});
    // Update category
    $(document).on("submit", "#updCategoryAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#updCategoryAjax', e, formData);
    ...
    $('#question_type').change(function (event) {
        ...
        window.location = '?type='+question_type;
    });


    // Add mlreport format
    $(document).on("submit", "#addMlReportAjax", function () {
        var e = $(this);
        var formData = $(this).serialize();
        sendAjaxRequest('#addMlReportAjax', e, formData);

        return false;
	});
    // Update mlreport format
    $(document).on("submit", "#updMlReportAjax", function (e) {
        e.preventDefault();
        var formData = new FormData(this);
            ...
            success: function (data) {
                if (data.status) {
                    ...
                    $.each(data.errors, function (key, val) {
                        ...
                        $('#updMlReportAjax .validation_errors.' + key + '_err').text(val);
                    });
                }
            },
            error: function (data) {
    ...
    //Save report
    $(document).on("submit", "#composerReportAjax", function (e) {
	    e.preventDefault();
        ...
        //Free Text 5
        let free_text5_enable = $('#composer_freetext5_heading .section-checker').is(':checked');
        ...
        //Free Text 9
        let free_text9_enable = $('#composer_freetext9_heading .section-checker').is(':checked');
        ...
        //Free Text 10
        let free_text10_enable = $('#composer_freetext10_heading .section-checker').is(':checked');
        ...
        //Free Text 11
        let free_text11_enable = $('#composer_freetext11_heading .section-checker').is(':checked');
        ...
        report['free_text11'] = {
         ...
         //Free Text 12
        let free_text12_enable = $('#composer_freetext12_heading .section-checker').is(':checked');
        ...
        //Free Text 13
        let free_text13_enable = $('#composer_freetext13_heading .section-checker').is(':checked');
        ...
        //Free Text 14
        let free_text14_enable = $('#composer_freetext14_heading .section-checker').is(':checked');
        ...
        if($('#composer_freetext15_heading .section-checker').is(':checked')) {
            ...
            let free_text15_enable = $('#composer_freetext15_heading .section-checker').is(':checked');
                ...
                success: function (data) {
                    if (data.status) {
                        ...
                        $.each(data.errors, function (key, val) {
                            ...
                            $('#composerReportAjax .validation_errors.' + key + '_err').text(val);
                        });
                    }
                },
                error: function (data) {
    ...
    $('.report-dcomposer').on("click", "#save_report_format_dcomposed", function (event) {
    ...
    //Save report format composed
    $(document).on("submit", "#saveComposerAjax", function (e) {
	    e.preventDefault();
    ...
    // Update company
    $(document).on("submit", "#updateCompanyProfileAjax", function (e) {
        e.preventDefault();
        var formData = new FormData(this);
            ...
            success: function (data) {
                if (data.status) {
                    ...
                    $.each(data.errors, function (key, val) {
                        ...
                        $('#updateCompanyProfileAjax .validation_errors.' + key + '_err').text(val);
                    });
                }
            },
            error: function (data) {
    ...
    $('#company_plan_editor1').on('change', '#company_plan_editor_classes', function () {
        ...
        $.ajax({
            ...
            headers: {'X-CSRF-Token': $('meta[name="csrf-token"]').attr('content')},
            type: 'POST',
            data: {"min_max": JSON.parse(min_max)},
            success: function (data) {
                let option_array = JSON.parse(data);
                let html = '<div class="company-package-ctn">';
                for (let key in option_array) {
                    html += `
                        <div class="company-single-package selectable" data-package_id="${option_array[key]['package_id']}">
                            <div class="price">
                                <br> <span class="value">${plan_editor.data('site_currency_symbol')}${option_array[key]['price']}</span><br> <span class="currency">${plan_editor.data('site_currency')} / ${select.data('phrase32')}</span>
                            </div>
                            <div class="name">
                                <label>${select.data('phrase34')} </label>
                                <span class="value">${option_array[key]['name']}</span>
                            </div>
                            <div class="user">
                                <label>${select.data('phrase33')} </label>
                                <span class="value">${option_array[key]['user']}</span>
                            </div>
                            <div class="details">
                                ${option_array[key]['details']}
    ...
    $('#company_plan_editor1').on('click', '#company_plan_editor_save', function (event) {
        ...
        $.ajax({
            ...
            headers: {'X-CSRF-Token': $('meta[name="csrf-token"]').attr('content')},
            type: 'POST',
            data: {"company_id": company_id, "package_id": package_value},
            success: function (data) {
                if (data.status) {
                    var shortCutFunction = "success"; //success, error, warning, info
                    toastr.options = {
    ...
    $('#save_ticket').click(function (event) {
        ...
        if (ticket_name.length < 1) {
            ...
            $.ajax({
                ...
                url: $(this).data('action'),
                type: 'POST',
                data: {'ticket_name': ticket_name, 'ticket_summary': ticket_summary ,'response': response, 'ticket_id': ticket_id},
                dataType: 'json',
                success: function (data) {
    ...
    $('#submit_ticket').click(function (event) {
        ...
        if (validation) {
            ...
            let submit_confirmation = confirm('Your ticket will get closed status. Are you sure? *When you close this case, you will get contacted by support within 1 day');
    ...
    $('#rating_submit').click(function (event) {
        event.preventDefault();
        let ticket_id = $(this).data('ticket_id');
        let ticket_rating_status = $(this).data('ticket_ratingstatus');
    ...
    if ($('.question-table-data').length > 0) {
        ...
        if (pageNum == 0) {
            ...
            page_number.html(categories[0]['category_name'] + '   <i class="fas fa-info-circle"></i>');
    ...
    $('.table-page-next').click(function () {
        if (!$(this).is(':disabled')) {
            ...
            $('.question-table .question-table-data').fadeOut(200, function () {
                let q_count = 0;
                $('.question-table .question-table-data tr').each(function (index) {
            ...
            let page_number = $('.table-page-number');
            page_number.html(categories[current_pos]['category_name'] + '   <i class="fas fa-info-circle"></i>');
            page_number.data('category_pos', current_pos);
            let category_text_custom = $('#category_text_custom');
            category_text_custom.text(removeTags(categories[current_pos]['category_details']));
   ...
   /* $('#admin_email_editor').on('click', '#admin_email_editor_save', function (event) {
    ...
    $('#company_plan_editor_classes').trigger('change')
    //showmoduleoption();
    ...
    $('#company_password_editor_button_admin').click(function () {
        let html = `
            <input type='password' name="password" id='company_pass_editor_new' class='form-control form-control-sm ml-1 mb-1' placeholder='New password'>
            <input type='password' name="password_confirmation" id='company_pass_editor_confirm' class='form-control form-control-sm ml-1 mb-1' placeholder='Confirm password'>
        `;
...
function imagePreview(fileInput) {
    if (fileInput.files && fileInput.files[0]) {
        ...
        fileReader.onload = function (event) {
            $('#preview').html('<img id="img" src="'+event.target.result+'" width="150" width="200" height="auto"/><br><p class="help-block">To replace this image click choose file</p>');
        };
   ...
   /* $('.deactivate_language').click(function () {
    ...
    /*$('#new_report_button').click(function (event) {
        ...
        if (new_report_name.length < 1) {
            new_report_name_input.css('border-bottom', '3px solid rgba(160, 0, 0, .5)');
            validation = validation & false;
        }
        if (validation) {
    ...
    /*$('.report_delete').click(function (event) {
        ...
        let delete_confirm = confirm('Selected Report format will be deleted! Please update all data associated with this format.');
        if (delete_confirm) {
            $.ajax({
                url: site_url + '/option_server.php',
                type: 'POST',
                data: {'sign': 'delete_report_format', 'report_format_id': report_format_id}
            }).done(function (data) {
                if (data == 'success') {
                    window.location.reload();
                } else
    ...
    /*$('.reportformat-translation-save').click(function () {
        let lang_code = $(this).data('lang_code');
        let report_format_id = $(this).data('report_format_id');
        let report_title = $(this).parents('.category-single-ctn').find('.report-name').val();
         let image_name = $(this).parents('.category-single-ctn').find('.uploaded_image').val();
        let report_desc = tinymce.editors[$(this).parents('.category-single-ctn').find('.category-details').attr('id')].getContent();
    ...
    /*$('#new_report_format_button').click(function (event) {
        ...
        if (report_format_name.length < 1) {
            report_format_name_input.css('border-bottom', '3px solid rgba(160, 0, 0, .5)');
            validation = validation & false;
        }
        if (report_format_description.length < 1) {
            report_format_description_input.css('border-bottom', '3px solid rgba(160, 0, 0, .5)');
            validation = validation & false;
        }
        ...
        if (validation) {
            ...
            $.ajax({
                url: site_url + '/option_server.php',
                type: 'POST',
                data: {'sign': 'add_report_format', 'report_format_name': report_format_name, 'report_format_description': report_format_description}
            }).done(function (data) {
                if (data == 'success') {
                    window.location.reload();
                } else {
     ...
     /*$('#new_mreport_format_button').click(function (event) {
        ...
        let report_format_description = report_format_description_input.val();
            ...
            $.ajax({
                url: site_url + '/option_server.php',
                type: 'POST',
                data: {'sign': 'add_mreport_format', 'report_format_name': report_format_name, 'report_format_description': report_format_description, 'report_lang' : mreport_lang}
            }).done(function (data) {
                if (data == 'success') {
                    window.location.reload();
                } else {
   ...
   /* $('#method_view').change(function () {
        ...
        $.ajax({
            ...
            for (let x = 0; x < methods.length; x++) {
                ...
                <div class="method-card text-gray-700 ${(methods[x]['method_company_id'] == company_id) ? 'method-highlight' : ''}">
                    ...
                    <a href=site_url + "/user/index.php?route=methods&id=${methods[x]['method_id']}" class="btn btn-primary btn-sm method-card-btn">
    ...
    /*$('#question_view').change(function () {
        ...
        if (company_id.length > 0) {
            window.location.href = site_url + "/user/index.php?route=questions&company=" + company_id;
        } else {
    ...
    /*$('.question-translation-save').click(function () {
        ...
        let question_option6_input = $(this).parents('.question-single-ctn').find('.question_option6');
        ...
        if (question_option6_input.length) question_option6 = question_option6_input.val();
    ...
    /*$('#create_ticket').click(function (event) {
        ...
        if (ticket_name.length < 1) {
            ...
            $.ajax({
                ...
                data = JSON.parse(data);
                if (data['status'] == 'success') {
                    window.location.href = site_url + "/user/index.php?route=ticket&id=" + data['ticket_id'] + "&page=intro";
                } else {
                    alert(data['message']);
                }
            })
    ...
    /*$('#update_ticket_summary').click(function (event) {
        ...
        if (ticket_name.length < 1) {
            ...
            $.ajax({
                ...
                data = JSON.parse(data);
                if (data['status'] == 'success') {
                    window.location.href = site_url + "/user/index.php?route=ticket&id=" + ticket_id + "&page=question";
                } else {
                    alert(data['message']);
                }
            });
            ...
            <div class="ticket-deadline-form">
                <form>
                    <div class="form-group">
                        <label for="ticket_deadline_date"> Deadline </label>
                        <input type="date" id="ticket_deadline_date" class="form-control" value="${ticket_end_date}">
                    </div>
                    <button type="submit" data-action=${action} id="ticket_deadline_save" class="btn btn-info" data-ticket_id="${ticket_id}">Save</button>
                </form>
            </div>
        `;
        ...
        if (submission) {
            $.ajax({
                ...
                if (data == 'success') {
                     ...
                     $('#success_message').html('<b>Graph Not Saved!</b>');
                     $('#success_message').delay(2000).fadeOut();
            });
        }
    })
    ...
    $('#tos_selection').change(function () {
        let company_id = $(this).val();
        if (company_id.length > 0) {
            console.log(tosWithCompURL);
            window.location.href = tosWithCompURL + '?addTosAjax=' + company_id;
        }
    });
    ...
    $('.package-add-new').click(function () {
        $('#language_select_box').trigger('change');
    ...
    $('.package-edit-btn').click(function () {
        ...
        $.each(package_info['package_name'], function( index, value ) {
            package_form.find('.package_new_name').eq(index).val(value);
        });
        $.each(package_info['package_details'], function( index, value ) {
            package_form.find('.package_new_details').eq(index).val(value);
        });
        ...
        package_form.find('#package_id').val($(this).data('package_id'));
...
function saveAndNavToReview(ticketId, ticketStatus) {
    if (ticketStatus == 'closed') {
        window.location.href = site_url + "/user/index.php?route=ticket&id=" + ticketId + "&page=review";
    } else {
        let ticket_name_input = $('#ticket_name');
        let ticket_name = ticket_name_input.val();
        let response = {};
        ...
        if (ticket_name.length < 1) {
            ...
            $.ajax({
                ...
                data = JSON.parse(data);
                if (data['status'] == 'success') {
                    window.location.href = site_url + "/user/index.php?route=ticket&id=" + data['ticket_id'] + "&page=review";
                } else {
                    alert(data['message']);
                }
            });
...
function showDeleteCompanyModal(companyId, lblClose, lblDelete) {
    ...
    htmlText += '<iframe class="modal-iframe" src=site_url + "/user/cmpny_del_warn.php"></iframe>';
...
/*function showmoduleoption() {
	...
	$('#question_con_type').change(function (event) {
        ...
        $.ajax({
            url: site_url + '/option_server.php',
            type: 'POST',
            data: {'sign': 'update_con_question_type', 'question_id': question_id, 'question_type': question_type}
        }).done(function (data) {
            if (data == 'success') {
                window.location.reload();
            } else {
	...
	$('#question_con_view').change(function () {
        let company_id = $(this).val();
        if (company_id.length > 0) {
            window.location.href = site_url + "/user/index.php?route=consultant&company=" + company_id;
        } else {
    ...
    $('#question_res_view').change(function () {
        let company_id = $(this).val();
        if (company_id.length > 0) {
            window.location.href = site_url + "/user/index.php?route=responder&company=" + company_id;
        } else {
	...
	$('#question_res_type').change(function (event) {
        ...
        $.ajax({
            url: site_url + '/option_server.php',
            type: 'POST',
            data: {'sign': 'update_res_question_type', 'question_id': question_id, 'question_type': question_type}
        }).done(function (data) {
            if (data == 'success') {
                window.location.reload();
            } else {
    ...
    $('#request_from_ticket').click(function (event) {
        ...
        if(permisson_ticket_title != '') {
            ...
            $.ajax({
                url: site_url + '/option_server.php',
                type: 'POST',
                data: {'sign': 'request_form', 'request_form_id': request_form_id, 'permission_by': permission_by, 'permisson_ticket_title': permisson_ticket_title}
            }).done(function (data) {
                data = JSON.parse(data);
                if (data['status'] == 'success') {
                    window.location.href = site_url + "/user/index.php?route=ticket&page=nticket_success";
                } else {
                    alert(data['message']);
                }
            })
             ...
             setTimeout(function() {$("#alertSectionemptyptitle").hide();}, 3000);
...
function sendAjaxRequest(id, e, formData){
    $.ajax({
        url: e.attr('action'),
        data: formData,
        type: "POST",
        ...
        success: function (data) {
            if (data.status) {
                ...
                $.each(data.errors, function (key, val) {
                    ...
                    $(id + ' .validation_errors.' + key + '_err').text(val);
                });
            }
        },
        error: function (data) {
