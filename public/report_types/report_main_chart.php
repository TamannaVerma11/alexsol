...
if(isset($_GET['id'])) {
    ...
    header("Location: https://beta.nogd.no");
    die();
}
?>
<!doctype html>
...
<form id="chartForm" method="post" action="/report_types/pdf_report_main.php">
...
<script src="/vendor/chartjs-2.9.3/Chart.min.js"></script>
...
<script type="module">
    ...
    function _chart(partition,data,d3,width,color,arc,format,radius)
    {
        ...
        // var canvasZoom = document.getElementById("myCanvas");

        // Convert the canvas to a JPEG image
        // var jpegImage = canvasZoom.toDataURL("image/jpeg");
        ...
        // document.getElementById("catChart").value = jpegImage;
