...
if (isset($_SESSION['account-type']) && isset($_GET['id']) && $_GET['id'] > 0) {
    ...
    function page_header_old($img)
    {
        $html = '';

        $html .= '<htmlpageheader name="firstpage" style="display:none;">';
        $html .= '<div><img src="https://beta.nogd.no/images/'.$img.'" /></div>';
        $html .= '</htmlpageheader>';

        $html .= '<htmlpageheader name="otherpages" style="display:none;">';
        $html .= '<div style="height: 30px;"></div>';
        $html .= '<div>
                    <img src="https://beta.nogd.no/images/logo-nogd-rapport.jpg" style="width: 200px; height: 80px; float: left" />
    ...
    function page_footer()
    {
        ...
        $html .= "<div style='float: right; text-align:right; width; 50px;'><span style='font-weight: bold; font-size: 16px; color: black;'>{PAGENO}</span>-{nbpg}</div>";
        $html .= '</htmlpagefooter>';
    ...
    */
        ...
        if ($report['intro_text']['enabled']) {
            ...
            $html .= '<table>
                        <tr>
                            ...
                            <td><img src="https://beta.nogd.no/images/logo-nogd-rapport.jpg" style="width: 200px; height: 80px; margin-left: 20px;" /></td>
                        </tr>
                    </table>';
            ...
            $html .= '</div>';
            $html .= '<div style="padding-top: 50px; margin-top: 70px; margin-bottom: 50px; margin-left: 25px; margin-right: 20px; font-size: 12pt; ">'.htmlspecialchars_decode($report['intro_text']['text']).'</div>';
    ...
    function free_text2($report, $trans, $index)
    {
        ...
        if ($report['free_text2']['enabled']) {
            $html .= '<div style="width: 100%;">';
            $html .= '<table><tr><td style="width: 30px"></td><td><img src="https://beta.nogd.no/images/logo-nogd-rapport.jpg" style="width: 200px; height: 80px; margin-left: 20px;" /></td></tr></table>';
            $html .= '<div style="width: 100%; height: 70px;"></div>';
            $html .= '<table style="width: 400px; font-size: 30px;">
                        <tr>
                            <td style="width: 40px;"></td>
    ...
    if ($report) {
        ...
        $common_prefix_html = "<body style='background-color: #fff; background-image:url(\"https://beta.nogd.no/images/4.png\"); background-image-resize: 6;'>".$page_footer.'<div>';
